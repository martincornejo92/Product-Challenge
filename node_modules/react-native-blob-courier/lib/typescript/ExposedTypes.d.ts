...
export declare interface BlobBaseRequest extends BlobRequestHeaders, BlobRequestOnProgress, BlobRequestUrl {
}
export declare interface BlobFetchRequest extends BlobBaseRequest, BlobRequestMimeType, BlobRequestMethod, AndroidFetchSettings, IOSFetchSettings {
...
export declare type TargetType = 'cache' | 'data';
export declare interface TargetSettings {
    target?: TargetType;
}
export declare interface AndroidFetchSettings {
    readonly android?: AndroidDownloadManagerToggle & AndroidDownloadManager & TargetSettings;
}
...
export declare type BlobMultipartFormData = string | {
    [key: string]: any;
};
...
export declare interface BlobUploadRequest extends BlobBaseRequest, BlobRequestMimeType, BlobRequestMethod, BlobRequestReturnResponse {
    readonly absoluteFilePath: string;
    readonly filename?: string;
    readonly multipartName?: string;
}
export declare interface BlobMultipartBaseRequest extends BlobBaseRequest, BlobRequestMethod, BlobRequestReturnResponse {
}
...
export declare enum BlobResponseType {
    Managed = 0,
    Unmanaged = 1
}
...
export declare type BlobFetchInput = BlobFetchRequest & BlobRequestSettings & AndroidFetchSettings & IOSFetchSettings;
export declare type BlobUploadInput = BlobUploadRequest & BlobRequestSettings;
