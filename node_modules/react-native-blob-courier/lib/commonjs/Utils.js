...
exports.uuid = exports.unionObjects = exports.sanitizeMappedMultiparts = exports.intersectObjects = exports.fallbackObjects = exports.convertMappedMultipartsWithSymbolizedKeysToArray = void 0;
...
const uuid = () => `${createUuidPart()}${createUuidPart()}`;

exports.uuid = uuid;

const intersectObjects = (primary, secondary) => [...new Set(Object.keys(primary).concat(Object.keys(secondary)))].reduce((p, c) => c in primary && c in secondary ? { ...p,
  [c]: primary[c] !== undefined ? primary[c] : secondary[c]
} : p, {});

exports.intersectObjects = intersectObjects;

const unionObjects = (primary, secondary) => [...new Set(Object.keys(primary).concat(Object.keys(secondary)))].reduce((p, c) => c in primary && c in secondary ? { ...p,
  [c]: primary[c] !== undefined ? primary[c] : secondary[c]
} : { ...p,
...
const fallbackObjects = (primary, fallback) => {
...
exports.fallbackObjects = fallbackObjects;

const convertMappedMultipartsWithSymbolizedKeysToArray = mappedParts => {
...
exports.convertMappedMultipartsWithSymbolizedKeysToArray = convertMappedMultipartsWithSymbolizedKeysToArray;

const sanitizeMappedMultiparts = mapped => {
...
exports.sanitizeMappedMultiparts = sanitizeMappedMultiparts;
